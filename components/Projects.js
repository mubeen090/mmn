        ...
        <Container>
          <div class="md:w-2/3 lg:w-1/2">
            ...
            <h2 class="my-8 text-2xl font-bold text-gray-700 dark:text-white md:text-4xl">
              "Unlock Your Potential with SkillIntern – Your Gateway to Excellence!

            </h2>
            <p class="text-gray-600 dark:text-gray-300">
              At SkillIntern, we don't just offer internships; we provide transformational experiences that will propel your career to new heights.
             Our platform connects you with industry experts, challenging projects, and exclusive job opportunities, 
             all designed to empower you to excel in your chosen field.
            </p>
          </div>
            ...
            <div class="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
              <div class="relative space-y-8 py-12 p-8">
                ...
                <div class="space-y-2">
                  ...
                  <p class="text-gray-600 dark:text-gray-300">
                  Gain 150+ hours of hands-on learning from industry experts.
                  </p>
                </div>
                <a
                  href="#"
            ...
            <div class="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
              <div class="relative space-y-8 py-12 p-8">
                ...
                <div class="space-y-2">
                  ...
                  <p class="text-gray-600 dark:text-gray-300">
                  Work on 4 mini and 4 major projects during your stipend-based internship.
                  Build a strong resume with real-world experience.
                  </p>
                </div>
                <a
                  href="#"
            ...
            <div class="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
              <div class="relative space-y-8 py-12 p-8">
                ...
                <div class="space-y-2">
                  ...
                  <p class="text-gray-600 dark:text-gray-300">
                  Sharpen your interview skills with 15 mock interviews and access to
                   8 interview opportunities.
                  </p>
                </div>
                <a
                  href="#"
            ...
            <div class="group relative bg-gray-50 dark:bg-gray-900 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
              <div class="relative space-y-8 py-12 p-8 transition duration-300 group-hover:bg-white dark:group-hover:bg-gray-800">
                ...
                <div class="space-y-2">
                  ...
                  <p class="text-gray-600 dark:text-gray-300">
                    fill the google form to know more 
                  </p>
                </div>
                <a
                  href="https://forms.gle/kMb7VnvTgVijGPJU9"
                  class="flex items-center justify-between group-hover:text-secondary"
                >
